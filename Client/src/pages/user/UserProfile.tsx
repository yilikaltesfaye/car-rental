		...
		<div className="max-w-3xl mx-auto p-6 flex flex-col gap-6">
			...
			<form className="flex flex-col gap-5" onSubmit={handleSubmit(onSubmit)}>
				...
				<button
					...
					className="mt-4 w-full py-3 bg-gray-950 text-white rounded-lg font-medium hover:bg-white hover:text-black border border-gray-950 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
				>
